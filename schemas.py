...
class LoginRequest(BaseModel):
    """
    Identificador flexible: puede ser el correo (usuario_mail) o el nombre de usuario (usuario_nombre).
    """
    identifier: str = Field(..., min_length=1, description="usuario_mail o usuario_nombre")
...
class UsuarioUpdate(BaseModel):
    ...
    usuario_mail: Optional[EmailStr] = None
...
# Tabla: evento
# =========================
EventoEstado = Literal["pendiente", "hecho", "cancelado"]

class EventoBase(BaseModel):
    evento_fecha_limite: datetime
...
class EventoUpdate(BaseModel):
    evento_fecha_limite: Optional[datetime] = None
    evento_descripcion: Optional[str] = None
